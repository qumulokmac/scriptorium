...
copy_tools() {
    ...
    run_command "curl -o /home/${ADMIN_USER}/azure_alg_suite.tgz 'https://YOUR_PRESIGNED_URL_HERE'"
    run_command "tar --no-xattrs -xf /home/${ADMIN_USER}/azure_alg_suite.tgz -C /home/qumulo adaptive_load_generator.sh start_load.sh"
}
