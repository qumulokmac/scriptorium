...
#     ./iperf3_fourhorsemen.sh -m client -s 10.10.60.11 -l /root/logs -p "5201,5202,5203,5204"
#
#   To start as a server:
#     ./iperf3_fourhorsemen.sh -m server -p '5201,5202,5203,5204'
#
#   To summarize logs:
#     ./iperf3_fourhorsemen.sh --summarize -l /root/logs
#
################################################################################

IPERF3_SERVER=""
LOG_DIR="fourhorsemen_logs"
...
Usage() {
            ...
            echo ""
            echo "To run the iperf3 servers, run \"$0 -m server \" on the chosen server"
            echo "To run the iperf3 clients, run \"$0 -m client -s IP_ADDRESS\" on the choseen client" 
            echo "To summarize the results, run \"$0 --summarize\" on the chosen client"
            echo ""
}
while [[ $# -gt 0 ]]; do
    case "$1" in
